...
//        myRandom.setSeed("Alcatel.123".getBytes());
        
        KeyGenerator keyGen = KeyGenerator.getInstance("AES");
        SecureRandom secureRandom = SecureRandom.getInstance("SHA1PRNG");
        secureRandom.setSeed("Alcatel.123".getBytes());
...
//        keyGen.init(128); //se indica el tamaño de la clave
        ...
        System.out.println("2.- Cifrar con AES el fichero: " + file + ", y dejar resultado en " + file + ".cifrado");
//declaración  de objetos
        ...
        bytesLeidos = fe.read(buffer, 0, 1024);
    ...
    private static void descifrarFichero(String file1, SecretKey key, String file2) throws NoSuchAlgorithmException, NoSuchPaddingException, FileNotFoundException, IOException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, InvalidAlgorithmParameterException {
        FileInputStream fe = null; //fichero de entrada
        FileOutputStream fs = null; //fichero de salida
        int bytesLeidos;
        Cipher cifrador = Cipher.getInstance("AES/CBC/PKCS5Padding");
        AlgorithmParameterSpec param = new IvParameterSpec("6OGqE3RXpxfqC".getBytes());
        //3.- Poner cifrador en modo DESCIFRADO o DESENCRIPTACIÓN
        cifrador.init(Cipher.DECRYPT_MODE, key, param);
